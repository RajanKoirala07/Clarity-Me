...
function getPasswordStrength(password: string): { label: PasswordStrength; color: string } {
  const checks = [
    password.length >= 8,
    /[A-Z]/.test(password),
    /[a-z]/.test(password),
...
export default function SignupScreen() {
  ...
  const canSubmit = requirements.every(r => r.met) && agreedToTerms && fullName.trim() && email.trim();
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity style={[styles.socialButton, styles.appleButton]}>
          <AntDesign name="apple1" size={20} color="#FFFFFF" style={styles.socialIcon} />
          <Text style={styles.appleButtonText}>Continue with Apple Sign In</Text>
        </TouchableOpacity>
